...
Se recomienda usar TLS en situaciones en las que desee configurar un canal seguro de correspondencia entre Office 365 y su organización local u otra organización, como un asociado. Exchange Online siempre intenta usar primero TLS para proteger el correo electrónico, pero no siempre es posible si la otra parte no proporciona seguridad TLS. Siga leyendo para averiguar cómo puede proteger todo el correo en los servidores locales o los asociados importantes mediante *conectores*. 
