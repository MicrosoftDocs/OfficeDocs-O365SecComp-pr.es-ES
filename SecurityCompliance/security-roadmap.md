...
Estas tareas pueden realizarse rápidamente y tienen un impacto bajo a los usuarios.
...
|Proteciton de información  <br/> | Revise las recomendaciones de protección de información de ejemplo. Protección de la información requiere coordinación en toda la organización. Empezar a trabajar con estos recursos:<br/> • [Protección de office 365 información para GDPR](http://aka.ms/o365gdpr) <br/> • [Archivos y sitios de SharePoint Online seguro](https://docs.microsoft.com/Office365/enterprise/secure-sharepoint-online-sites-and-files) (que incluye el uso compartido, clasificación, prevención de pérdida de datos y protección de la información de Azure)  <br/> |
   
## <a name="90-days--enhanced-protections"></a>90 días: mejorado protecciones
<a name="Ninetydays"> </a>

Estas tareas tardan un poco más tiempo para planear e implementar pero aumenta considerablemente el nivel de seguridad. 
...
|Proteciton de información  <br/> | • Refinar directivas y procesos operativos.  <br/>  • Protección de identidad usar Azure AD para identificar amenazas internas.  <br/> |
