...
## [Instalar el complemento de supervisión de Outlook para escritorio](install-the-supervision-add-in-for-outlook-desktop.md)
...
### [Usar notificaciones y sugerencias de directivas en directivas DLP](use-notifications-and-policy-tips.md)
...
### [Cómo Office 365 valida la dirección remitente para evitar la suplantación de identidad](how-office-365-validates-the-from-address.md)
...
### [Preguntas más frecuentes de cifrado de mensajes de Office 365](ome-faq.md)
...
### [ATP de Office 365 para SharePoint, OneDrive y Microsoft Teams](atp-for-spo-odb-and-teams.md).
#### [Activar ATP para SharePoint, OneDrive y Microsoft Teams](turn-on-atp-for-spo-odb-and-teams.md).
#### [Archivos malintencionados en Microsoft Teams, OneDrive o SharePoint](malicious-files-detected-in-spo-odb-or-teams.md)
...
### [Importar contenido que no sea de Office 365 para el análisis de eDiscovery avanzado](import-non-office-365-data-into-advanced-ediscovery.md)
### [Configurar usuarios y casos en eDiscovery avanzado de Office 365](set-up-users-and-cases-in-advanced-ediscovery.md)
### [Exportar resultados en eDiscovery avanzado de Office 365](export-results-in-advanced-ediscovery.md)
### [Ejecutar el módulo de proceso en eDiscovery avanzado de Office 365](run-the-process-module-in-advanced-ediscovery.md)
### [Analizar datos de casos con eDiscovery avanzado de Office 365](analyze-case-data-with-advanced-ediscovery.md)
### [Exportar datos de casos en eDiscovery avanzado de Office 365](export-case-data-in-advanced-ediscovery.md)
### [Usar herramientas de eDiscovery avanzado de Office 365](use-advanced-ediscovery-utilities.md)
### [Roles y acceso de usuarios en eDiscovery avanzado de Office 365](user-roles-and-access-in-advanced-ediscovery.md)
### [Administrar la configuración de relevancia en eDiscovery avanzado de Office 365](manage-relevance-setup-in-advanced-ediscovery.md)
### [Usar el módulo de relevancia en eDiscovery avanzado de Office 365](use-relevance-in-advanced-ediscovery.md)
### [Aprendizaje de relevancia y etiquetas en eDiscovery avanzado de Office 365](tagging-and-relevance-training-in-advanced-ediscovery.md)
### [Ejecutar el módulo de proceso y cargar datos en eDiscovery avanzado de Office 365](run-the-process-module-and-load-data-in-advanced-ediscovery.md)
### [Definir la configuración de casos e inquilinos en eDiscovery avanzado de Office 365](define-case-and-tenant-settings-in-advanced-ediscovery.md)
### [Ejecutar informes en eDiscovery avanzado de Office 365](run-reports-in-advanced-ediscovery.md)
### [Ver los resultados de análisis en eDiscovery avanzado de Office 365](view-analyze-results-in-advanced-ediscovery.md)
### [Usar análisis rápido en eDiscovery avanzado de Office 365](use-express-analysis-in-advanced-ediscovery.md)
### [Preparar datos para eDiscovery avanzado de Office 365](prepare-data-for-advanced-ediscovery.md)
### [Exportar campos de resultados en eDiscovery avanzado de Office 365](export-report-fields-in-advanced-ediscovery.md)
### [Etiquetado y evaluación en eDiscovery avanzado de Office 365](tagging-and-assessment-in-advanced-ediscovery.md)
### [Comprender la similitud de documentos en eDiscovery avanzado de Office 365](understand-document-similarity-in-advanced-ediscovery.md)
### [Definir las palabras clave resaltadas y las opciones avanzadas en eDiscovery avanzado de Office 365](define-highlighted-keywords-and-advanced-options.md)
### [Establecer la opción de omitir el texto para analizar en eDiscovery avanzado de Office 365](set-ignore-text-in-advanced-ediscovery.md)
### [Ver el historial del lote y exportar resultados pasados en eDiscovery avanzado de Office 365](view-batch-history-and-export-past-results.md)
### [Establecer opciones de analizar en eDiscovery avanzado de Office 365](set-analyze-options-in-advanced-ediscovery.md)
### [Ver resultados del módulo de proceso en eDiscovery avanzado de Office 365](view-process-module-results-in-advanced-ediscovery.md)
### [Seguimiento del análisis de relevancia en eDiscovery avanzado de Office 365](track-relevance-analysis-in-advanced-ediscovery.md)
### [Decisión según los resultados en eDiscovery avanzado de Office 365](decision-based-on-the-results-in-advanced-ediscovery.md)
### [Probar análisis de relevancia en eDiscovery avanzado de Office 365](test-relevance-analysis-in-advanced-ediscovery.md)
### [Configurar cargas para agregar archivos importados en eDiscovery avanzado de Office 365](set-up-loads-to-add-imported-files.md)
### [Definir problemas y asignar usuarios en eDiscovery avanzado de Office 365](define-issues-and-assign-users.md)
### [Establecer opciones avanzadas de analizar en eDiscovery avanzado de Office 365](set-analyze-options-in-advanced-ediscovery.md)
### [Comprender la evaluación de relevancia en eDiscovery avanzado de Office 365](assessment-in-relevance-in-advanced-ediscovery.md)
### [Búsqueda y etiquetado](search-and-tagging.md)
...
## [Informes inteligentes y reportes en el Centro de cumplimiento y seguridad](reports-and-insights-in-security-and-compliance.md)
...
### [Introducción: Protección de Office 365 para RGPD](https://docs.microsoft.com/Office365/Enterprise/office-365-info-protection-for-gdpr-overview)
...
### [Diseño de un esquema de clasificación de planes personales](https://docs.microsoft.com/Office365/Enterprise/architect-a-classification-schema-for-personal-data)
