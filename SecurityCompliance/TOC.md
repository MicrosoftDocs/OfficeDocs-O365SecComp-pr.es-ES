...
## [Actualizaciones recientes de contenido de cumplimiento](new-updated-compliance-content.md)
...
### [Establecer una fecha de expiración para el correo electrónico cifrado por el cifrado avanzado de mensajes de Office 365](ome-advanced-expiration.md)
...
## [Garantizar la seguridad de los usuarios con la investigación y respuesta ante amenazas](keep-users-safe-with-office-365-ti.md)
## [Investigar y responder automáticamente ante amenazas en Office 365](office-365-air.md)
...
### [Cómo funciona la respuesta automática a incidentes](automated-investigation-response-office.md)
...
### [Administrar conjuntos de revisión](compliance20/managing-review-sets.md)
...
### [Eliminar elementos de su ubicación original](datainvestigations/delete-items-from-original-locations.md)
...
# Características de seguridad y cumplimiento heredadas
