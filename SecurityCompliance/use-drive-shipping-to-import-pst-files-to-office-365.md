...
- La unidad de disco duro en la que se copian los archivos PST debe estar cifrada con BitLocker. La herramienta herramienta waimportexport. exe que ejecutó en el paso 2 le ayudará a configurar BitLocker. También genera una clave de cifrado de BitLocker que usará el personal del centro de datos de Microsoft para acceder a la unidad para cargar los archivos PST en el área de almacenamiento de Azure en la nube de Microsoft.
...
> [!IMPORTANT]
> Después de ejecutar la herramienta herramienta waimportexport. exe la primera vez para una unidad de disco duro, debe usar una sintaxis diferente cada vez después de eso. Esta sintaxis se explica en el paso 4 de este procedimiento para copiar los archivos PST en la unidad de disco duro. 
...
3. Ejecute el siguiente comando la primera vez que use la herramienta WAImportExport.exe para copiar archivos PST en una unidad de disco duro.
  ...
  <br/> El personal del centro de datos de Microsoft usará la información del archivo de diario para asociar la unidad de disco duro con el trabajo de importación que ha creado en el paso 4 y para cargar los archivos PST en el área de almacenamiento de Azure en la nube de Microsoft.  <br/> | `/j:PSTHDD1.jrn` <br/> |
...
2. Abra o guarde el archivo CSV en el equipo local. En el ejemplo siguiente se muestra un archivo de asignación de importaciones de archivos PST completado (que se abre en el Bloc de notas). Es mucho más fácil usar Microsoft Excel para editar el archivo CSV.
    ...
    En la primera fila, o fila de encabezado, del archivo CSV se enumeran los parámetros que usará el servicio de importación de PST para importar los archivos PST a los buzones de usuario. Cada nombre de parámetro está separado por una coma. Cada fila situada debajo de la fila de encabezado representa los valores de parámetro para importar un archivo PST a un buzón específico. Necesitará una fila para cada archivo PST que se copió en la unidad de disco duro. Asegúrese de reemplazar los datos de marcador de posición en el archivo de asignación con los datos reales.
...
7. En la página **seleccionar el archivo de unidad** , haga clic en **Seleccionar archivo de unidad**y, a continuación, vaya a la misma carpeta en la que se encuentra la herramienta herramienta waimportexport. exe. El archivo de diario que se creó en el paso 2 se copió en esta carpeta.
...
14. En la página **proporcionar información de contacto** , escriba la información de contacto en las casillas correspondientes. 
    ...
    Tenga en cuenta que se muestra la dirección de la ubicación de Microsoft a la que enviará las unidades de disco duro. Esta dirección se genera automáticamente en función de la ubicación del centro de datos de Office 365. Copie esta dirección en un archivo o realice una captura de pantalla.
...
- Envíe la unidad de disco duro a la dirección de la ubicación de Microsoft que se mostró al crear el trabajo de importación en el paso 4. Asegúrese de incluir "servicio de importación de Office 365" en la dirección de envío.
...
7. Una vez mostrada la dirección URL, cópiela y guárdela en un archivo. Asegúrese de copiar la dirección URL completa.
