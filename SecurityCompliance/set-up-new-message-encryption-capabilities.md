...
2. Ejecute el cmdlet Get-IRMConfiguration.
     ...
     Debería ver un valor $Verdadero para el parámetro AzureRMSLicensingEnabled, el cuál indica que OME está configurado en su espacio empresarial. Si no lo está, utilice set-IRMConfiguration para establecer el valor de AzureRMSLicensingEnabled en $Verdadero para habilitar OME.
...
3. Ejecute el cmdlet test-IRMConfiguration usando la siguiente sintaxis:
   ...
   **Ejemplo**:
     ...
     Sus resultados deben ser similares a:
...
>[!IMPORTANT]
>Si no actualiza las reglas de flujo de correo existentes, los usuarios seguirán recibiendo correo cifrado que utiliza el formato de archivo adjunto HTML anterior, en lugar de la nueva experiencia de OME de conexión directa.
...
3. Para cada regla, en **Haga lo siguiente**:
