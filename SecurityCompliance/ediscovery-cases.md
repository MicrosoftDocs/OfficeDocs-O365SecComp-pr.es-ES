...
6. Bajo **ubicaciones: las ubicaciones en espera**, elija las ubicaciones de contenido que se va a buscar. Puede buscar los buzones de correo, sitios y las carpetas públicas en la misma búsqueda.
...
7. Después de seleccionar las ubicaciones de contenido de búsqueda, haga clic en **Listo** y, a continuación, haga clic en **Guardar**.
    
8. En la página **nueva búsqueda** , haga clic en **Guardar** y, a continuación, escriba un nombre para la búsqueda. Búsquedas de contenido asociadas con un caso deben tener nombres que son únicos dentro de la organización de Office 365. 
    
9. Haga clic en **Guardar &amp; ejecutar** para guardar la configuración de búsqueda. 
    
10. Escriba un nombre único para la búsqueda y haga clic en **Guardar** para iniciar la búsqueda. 
