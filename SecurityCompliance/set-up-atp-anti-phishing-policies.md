...
1. [Revise los requisitos previos](set-up-atp-anti-phishing-policies.md#phishprereq)
    
2. [Obtenga información acerca de las opciones de directiva contra suplantación de identidad de ATP](set-up-atp-anti-phishing-policies.md#phishpolicyoptions)
    
3. [Establecer una directiva de ATP contra suplantación de identidad](set-up-atp-anti-phishing-policies.md#addphishpolicy)
...
- [Obtenga información acerca de las opciones de directiva contra suplantación de identidad de ATP](set-up-atp-anti-phishing-policies.md#phishpolicyoptions) (en este artículo). 
...
5. Especifique el nombre, la descripción y la configuración para la directiva. Para obtener más información, vea [Aprenda acerca de las opciones de directiva contra suplantación de identidad de ATP](set-up-atp-anti-phishing-policies.md#phishpolicyoptions) . 
...
En este ejemplo se configura una directiva denominada a "Dominio y CEO" que proporciona protección de dominio de suplantación y de usuario y, a continuación, se aplica la directiva a todos los correos electrónicos recibidos por los usuarios en el dominio contoso.com. El Administrador de seguridad ha determinado que la directiva debe cumplir estos requisitos empresariales:
