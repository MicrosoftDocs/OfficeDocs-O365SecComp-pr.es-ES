---
title: "cifrado de correo electrónico en Office 365" MS. Author: krowley Author: kccross Manager: laurawi ms. Date: 10/30/2018 ms. Audience: admin ms. topic: información general ms. Service: o365-administración localization_priority: búsqueda normal. appverid: 
- MOE150
- MET150 ms. AssetID: c0d87cbe-6d65-4c03-88ad-5216ea5564e8 ms. Collection:
    - M365-Security-Compliance Description: "Compare opciones de cifrado en Office 365, incluido el cifrado de mensajes de Office (OME), S/MIME, Information Rights Management (IRM) y obtenga información acerca de la seguridad de la capa de transporte (TLS)."
---
...
Office 365 ofrece varias opciones de cifrado para satisfacer las necesidades de la empresa relacionadas con la seguridad del correo electrónico. En este artículo se presentan tres formas de cifrar el correo electrónico en Office 365. Si desea obtener más información sobre todas las características de seguridad de Office 365, visite el [centro de confianza de office 365](http://go.microsoft.com/fwlink/p/?LinkID=282470). En este artículo se presentan los tres tipos de cifrado disponibles para los administradores de Office 365 para ayudar a proteger el correo electrónico en Office 365:
...
Para obtener información acerca de las opciones de cifrado de correo electrónico para su suscripción a Office 365, consulte [Descripción del servicio Exchange Online](https://technet.microsoft.com/en-us/library/exchange-online-service-description.aspx). Aquí encontrará información sobre las siguientes características de cifrado:
...
"Datos en reposo" se refiere a datos que no están en tránsito de forma activa. En Office 365, los datos de correo electrónico en reposo se cifran mediante el Cifrado de unidad BitLocker. BitLocker cifra las unidades de disco duro en centros de datos de Office 365 para proporcionar mayor protección frente a accesos no autorizados. Para obtener más información, consulte [Información general sobre BitLocker](https://go.microsoft.com/fwlink/p/?LinkId=394737).
