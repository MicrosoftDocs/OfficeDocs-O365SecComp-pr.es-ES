...
|Destinatarios|Todos los campos de destinatarios en un mensaje de correo electrónico. Estos campos son Para, CC y CCO.<sup>1</sup>|`recipients:garthf@contoso.com`  <br/> `recipients:contoso.com`|Mensajes enviados a garthf@contoso.com. El segundo ejemplo devuelve los mensajes enviados a todos los destinatarios en el dominio contoso.com.|
...
|**Operador**|**Equivalente de consulta**|**Descripción**|
|:-----|:-----|:-----|
