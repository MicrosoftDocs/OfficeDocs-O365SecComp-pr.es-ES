...
|**Actividad de archivo de usuario externo inusual** <br/> |Genera una alerta cuando los usuarios que se encuentran fuera de la organización realizan un gran número de actividades en los archivos de SharePoint o OneDrive. Esto incluye actividades como obtener acceso a archivos, descargar archivos y eliminar archivos. Esta directiva tiene una configuración de gravedad **alta** .  <br/> |Gobierno de datos<br/> |E5/G5, Office 365 ATP P2 o suscripción de complemento de cumplimiento avanzado  <br/> |
|**Volumen inusual de uso compartido de archivos externos** <br/> |Genera una alerta cuando se comparte con usuarios fuera de la organización un número normalmente grande de archivos en SharePoint o OneDrive. Esta directiva tiene una configuración de gravedad **media** .  <br/> |Gobierno de datos<br/> |E5/G5, Office 365 ATP P2 o suscripción de complemento de cumplimiento avanzado  <br/> |
