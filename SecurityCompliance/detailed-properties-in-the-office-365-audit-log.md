...
|Ruta de acceso|El nombre de la carpeta del buzón donde se encuentra el mensaje al que se obtuvo acceso. Esta propiedad también identifica la carpeta a donde se crea o se copia o se mueve un mensaje.|Exchange (actividad de buzón de correo)|
