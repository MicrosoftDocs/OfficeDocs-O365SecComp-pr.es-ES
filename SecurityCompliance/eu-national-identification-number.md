...
### <a name="pattern"></a><span data-ttu-id="62afb-110">Patrón</span><span class="sxs-lookup"><span data-stu-id="62afb-110">Pattern</span></span>
...
#### <a name="keywordsaustriaeunationalidcard"></a><span data-ttu-id="62afb-121">Keywords_austria_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="62afb-121">Keywords_austria_eu_national_id_card</span></span>
...
- <span data-ttu-id="62afb-136">Un dígito que corresponde al género: un dígito par para macho y un dígito impar para hembra</span><span class="sxs-lookup"><span data-stu-id="62afb-136">One digit that corresponds to gender: An even digit for male and an odd digit for female</span></span>
...
#### <a name="keywordsbulgarianationalnumber"></a><span data-ttu-id="62afb-147">Keywords_bulgaria_national_number</span><span class="sxs-lookup"><span data-stu-id="62afb-147">Keywords_bulgaria_national_number</span></span>
...
### <a name="keywords"></a><span data-ttu-id="62afb-178">Palabras clave</span><span class="sxs-lookup"><span data-stu-id="62afb-178">Keywords</span></span>
...
<span data-ttu-id="62afb-191">11 dígitos sin espacios y delimitadores</span><span class="sxs-lookup"><span data-stu-id="62afb-191">11 digits without spaces and delimiters</span></span>
...
- <span data-ttu-id="62afb-205">La función `Func_estonia_eu_national_id_card` busca contenido que coincide con el patrón.</span><span class="sxs-lookup"><span data-stu-id="62afb-205">The function  `Func_estonia_eu_national_id_card` finds content that matches the pattern.</span></span> 
...
<span data-ttu-id="62afb-229">11 dígitos:</span><span class="sxs-lookup"><span data-stu-id="62afb-229">11 digits:</span></span>
...
### <a name="keywords"></a><span data-ttu-id="62afb-242">Palabras clave</span><span class="sxs-lookup"><span data-stu-id="62afb-242">Keywords</span></span>
...
<span data-ttu-id="62afb-257">Antes del 01 de enero de 2013:</span><span class="sxs-lookup"><span data-stu-id="62afb-257">Prior to 01 January 2013:</span></span>
...
### <a name="keywords"></a><span data-ttu-id="62afb-269">Palabras clave</span><span class="sxs-lookup"><span data-stu-id="62afb-269">Keywords</span></span>
...
- <span data-ttu-id="62afb-286">Tres letras que corresponden a las tres primeras consonantes en el nombre de la familia</span><span class="sxs-lookup"><span data-stu-id="62afb-286">Three letters that correspond to the first three consonants in the family name</span></span>
...
<span data-ttu-id="62afb-312">personal numero</span><span class="sxs-lookup"><span data-stu-id="62afb-312">numero personale</span></span>
...
<span data-ttu-id="62afb-339">número de identificación personal</span><span class="sxs-lookup"><span data-stu-id="62afb-339">personal id number</span></span>
...
- <span data-ttu-id="62afb-355">La función `Func_lithuania_eu_national_id_card` busca contenido que coincide con el patrón.</span><span class="sxs-lookup"><span data-stu-id="62afb-355">The function  `Func_lithuania_eu_national_id_card` finds content that matches the pattern.</span></span> 
...
<span data-ttu-id="62afb-367">asmeninis skaitmeninis kodas</span><span class="sxs-lookup"><span data-stu-id="62afb-367">asmeninis skaitmeninis kodas</span></span>
...
### <a name="definition"></a><span data-ttu-id="62afb-383">Definición</span><span class="sxs-lookup"><span data-stu-id="62afb-383">Definition</span></span>
...
<span data-ttu-id="62afb-396">uniqueidkey #</span><span class="sxs-lookup"><span data-stu-id="62afb-396">uniqueidkey#</span></span>
...
<span data-ttu-id="62afb-414">No aplicable</span><span class="sxs-lookup"><span data-stu-id="62afb-414">Not applicable</span></span>
...
<span data-ttu-id="62afb-423">código numérico personal</span><span class="sxs-lookup"><span data-stu-id="62afb-423">personal numeric code</span></span>
...
<span data-ttu-id="62afb-451">uniqueidentityno #</span><span class="sxs-lookup"><span data-stu-id="62afb-451">uniqueidentityno#</span></span>
...
<span data-ttu-id="62afb-466">13 dígitos</span><span class="sxs-lookup"><span data-stu-id="62afb-466">13 digits</span></span>
...
#### <a name="keywordsromaniaeunationalidcard"></a><span data-ttu-id="62afb-476">Keywords_romania_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="62afb-476">Keywords_romania_eu_national_id_card</span></span>
...
<span data-ttu-id="62afb-495">numărpersonalunic #</span><span class="sxs-lookup"><span data-stu-id="62afb-495">numărpersonalunic#</span></span>
...
<span data-ttu-id="62afb-523">rodne cislo</span><span class="sxs-lookup"><span data-stu-id="62afb-523">rodne cislo</span></span>
...
-  <span data-ttu-id="62afb-529">Siete dígitos que corresponden a la fecha de nacimiento (DDMMLLL) donde "LLL" corresponde a los tres últimos dígitos del año de nacimiento.</span><span class="sxs-lookup"><span data-stu-id="62afb-529">Seven digits that correspond to the birth date (DDMMLLL) where "LLL" corresponds to the last three digits of the birth year</span></span> 
    
- <span data-ttu-id="62afb-530">Dos dígitos que corresponden al área de nacimiento</span><span class="sxs-lookup"><span data-stu-id="62afb-530">Two digits that correspond to the area of birth</span></span>
    
- <span data-ttu-id="62afb-531">Tres dígitos que corresponden a una combinación de sexo y número de serie de las personas nacidos el mismo día (000-499 para macho y 500-999 para hembras)</span><span class="sxs-lookup"><span data-stu-id="62afb-531">Three digits that correspond to a combination of gender and serial number for persons born on the same day (000-499 for male and 500-999 for female)</span></span>
    
- <span data-ttu-id="62afb-532">Un dígito de control</span><span class="sxs-lookup"><span data-stu-id="62afb-532">One check digit</span></span>
    
### <a name="checksum"></a><span data-ttu-id="62afb-533">Suma de comprobación</span><span class="sxs-lookup"><span data-stu-id="62afb-533">Checksum</span></span>

<span data-ttu-id="62afb-534">Sí</span><span class="sxs-lookup"><span data-stu-id="62afb-534">Yes</span></span>
  
### <a name="definition"></a><span data-ttu-id="62afb-535">Definición</span><span class="sxs-lookup"><span data-stu-id="62afb-535">Definition</span></span>

<span data-ttu-id="62afb-536">Una directiva DLP está segura al 85% de que este tipo de información confidencial se detecta si, en una proximidad de 300 caracteres:</span><span class="sxs-lookup"><span data-stu-id="62afb-536">A DLP policy is 85% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="62afb-537">La función `Func_slovenia_eu_national_id_card` busca contenido que coincide con el patrón.</span><span class="sxs-lookup"><span data-stu-id="62afb-537">The function  `Func_slovenia_eu_national_id_card` finds content that matches the pattern.</span></span> 
    
- <span data-ttu-id="62afb-538">Se encuentra una `Keywords_slovenia_eu_national_id_card` palabra clave de.</span><span class="sxs-lookup"><span data-stu-id="62afb-538">A keyword from  `Keywords_slovenia_eu_national_id_card` is found.</span></span> 
    
<span data-ttu-id="62afb-539">Una directiva DLP está segura al 75% de que este tipo de información confidencial se detecta si, en una proximidad de 300 caracteres:</span><span class="sxs-lookup"><span data-stu-id="62afb-539">A DLP policy is 75% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="62afb-540">La función `Func_slovenia_eu_national_id_card` busca contenido que coincide con el patrón.</span><span class="sxs-lookup"><span data-stu-id="62afb-540">The function  `Func_slovenia_eu_national_id_card` finds content that matches the pattern.</span></span> 
...
### <a name="keywords"></a><span data-ttu-id="62afb-541">Palabras clave</span><span class="sxs-lookup"><span data-stu-id="62afb-541">Keywords</span></span>

#### <a name="keywordssloveniaeunationalidcard"></a><span data-ttu-id="62afb-542">Keywords_slovenia_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="62afb-542">Keywords_slovenia_eu_national_id_card</span></span>

<span data-ttu-id="62afb-543">código numérico personal</span><span class="sxs-lookup"><span data-stu-id="62afb-543">personal numeric code</span></span>
  
<span data-ttu-id="62afb-544">número de identificación único</span><span class="sxs-lookup"><span data-stu-id="62afb-544">unique identification number</span></span>
  
<span data-ttu-id="62afb-545">número de registro único</span><span class="sxs-lookup"><span data-stu-id="62afb-545">unique registration number</span></span>
  
<span data-ttu-id="62afb-546">número de identidad único</span><span class="sxs-lookup"><span data-stu-id="62afb-546">unique identity number</span></span>
  
<span data-ttu-id="62afb-547">uniqueidentityno #</span><span class="sxs-lookup"><span data-stu-id="62afb-547">uniqueidentityno#</span></span>
  
<span data-ttu-id="62afb-548">número único de ciudadano principal</span><span class="sxs-lookup"><span data-stu-id="62afb-548">unique master citizen number</span></span>
  
<span data-ttu-id="62afb-549">edinstvena identifikacijska številka</span><span class="sxs-lookup"><span data-stu-id="62afb-549">edinstvena identifikacijska številka</span></span>
  
<span data-ttu-id="62afb-550">uniqueidentityno #</span><span class="sxs-lookup"><span data-stu-id="62afb-550">uniqueidentityno #</span></span>
  
<span data-ttu-id="62afb-551">edinstvena številka glavnega državljana</span><span class="sxs-lookup"><span data-stu-id="62afb-551">edinstvena številka glavnega državljana</span></span>
  
<span data-ttu-id="62afb-552">emšo</span><span class="sxs-lookup"><span data-stu-id="62afb-552">emšo</span></span>
  
## <a name="spain"></a><span data-ttu-id="62afb-553">España</span><span class="sxs-lookup"><span data-stu-id="62afb-553">Spain</span></span>

### <a name="format"></a><span data-ttu-id="62afb-554">Dé</span><span class="sxs-lookup"><span data-stu-id="62afb-554">Format</span></span>

<span data-ttu-id="62afb-555">Siete dígitos seguidos de un carácter</span><span class="sxs-lookup"><span data-stu-id="62afb-555">Seven digits followed by one character</span></span>
  
### <a name="pattern"></a><span data-ttu-id="62afb-556">Patrón</span><span class="sxs-lookup"><span data-stu-id="62afb-556">Pattern</span></span>

<span data-ttu-id="62afb-557">Siete dígitos seguidos de un carácter</span><span class="sxs-lookup"><span data-stu-id="62afb-557">Seven digits followed by one character</span></span>
  
- <span data-ttu-id="62afb-558">Siete dígitos </span><span class="sxs-lookup"><span data-stu-id="62afb-558">Seven digits</span></span>
    
- <span data-ttu-id="62afb-559">Un dígito o letra (no distingue entre mayúsculas y minúsculas)</span><span class="sxs-lookup"><span data-stu-id="62afb-559">One digit or letter (not case-sensitive)</span></span>
    
### <a name="checksum"></a><span data-ttu-id="62afb-560">Suma de comprobación</span><span class="sxs-lookup"><span data-stu-id="62afb-560">Checksum</span></span>

<span data-ttu-id="62afb-561">No aplicable</span><span class="sxs-lookup"><span data-stu-id="62afb-561">Not applicable</span></span>
  
### <a name="definition"></a><span data-ttu-id="62afb-562">Definición</span><span class="sxs-lookup"><span data-stu-id="62afb-562">Definition</span></span>

<span data-ttu-id="62afb-563">Una directiva DLP está segura al 75% de que este tipo de información confidencial se detecta si, en una proximidad de 300 caracteres:</span><span class="sxs-lookup"><span data-stu-id="62afb-563">A DLP policy is 75% confident that it's detected this type of sensitive information if, within a proximity of 300 characters:</span></span>
  
- <span data-ttu-id="62afb-564">La expresión `Regex_spain_eu_national_id_card` regular busca contenido que coincide con el patrón.</span><span class="sxs-lookup"><span data-stu-id="62afb-564">The regular expression  `Regex_spain_eu_national_id_card` finds content that matches the pattern.</span></span> 
    
- <span data-ttu-id="62afb-565">Se encuentra una `Keywords_spain_eu_national_id_card"` palabra clave de.</span><span class="sxs-lookup"><span data-stu-id="62afb-565">A keyword from  `Keywords_spain_eu_national_id_card"` is found.</span></span> 
...
### <a name="keywords"></a><span data-ttu-id="62afb-566">Palabras clave</span><span class="sxs-lookup"><span data-stu-id="62afb-566">Keywords</span></span>

#### <a name="keywordsspaineunationalidcard"></a><span data-ttu-id="62afb-567">Keywords_spain_eu_national_id_card</span><span class="sxs-lookup"><span data-stu-id="62afb-567">Keywords_spain_eu_national_id_card</span></span>

<span data-ttu-id="62afb-568">DNI</span><span class="sxs-lookup"><span data-stu-id="62afb-568">dni</span></span>
  
<span data-ttu-id="62afb-569">national identification number</span><span class="sxs-lookup"><span data-stu-id="62afb-569">national identification number</span></span>
  
<span data-ttu-id="62afb-570">número de identidad nacional</span><span class="sxs-lookup"><span data-stu-id="62afb-570">national identity number</span></span>
  
<span data-ttu-id="62afb-571">número de seguro</span><span class="sxs-lookup"><span data-stu-id="62afb-571">insurance number</span></span>
  
<span data-ttu-id="62afb-572">número de identificación personal</span><span class="sxs-lookup"><span data-stu-id="62afb-572">personal identification number</span></span>
  
<span data-ttu-id="62afb-573">identidad nacional</span><span class="sxs-lookup"><span data-stu-id="62afb-573">national identity</span></span>
  
<span data-ttu-id="62afb-574">número de la identidad personal</span><span class="sxs-lookup"><span data-stu-id="62afb-574">personal identity no</span></span>
  
<span data-ttu-id="62afb-575">número de identidad único</span><span class="sxs-lookup"><span data-stu-id="62afb-575">unique identity number</span></span>
  
<span data-ttu-id="62afb-576">nationalidno #</span><span class="sxs-lookup"><span data-stu-id="62afb-576">nationalidno#</span></span>
  
<span data-ttu-id="62afb-577">UniqueID</span><span class="sxs-lookup"><span data-stu-id="62afb-577">uniqueid#</span></span>
  
<span data-ttu-id="62afb-578">DNI</span><span class="sxs-lookup"><span data-stu-id="62afb-578">dni#</span></span>
  
<span data-ttu-id="62afb-579">nationalid #</span><span class="sxs-lookup"><span data-stu-id="62afb-579">nationalid#</span></span>
  
<span data-ttu-id="62afb-580">NIE</span><span class="sxs-lookup"><span data-stu-id="62afb-580">nie#</span></span>
  
<span data-ttu-id="62afb-581">NIE</span><span class="sxs-lookup"><span data-stu-id="62afb-581">nie</span></span>
  
<span data-ttu-id="62afb-582">nienúmero #</span><span class="sxs-lookup"><span data-stu-id="62afb-582">nienúmero#</span></span>
  
<span data-ttu-id="62afb-583">NIE número</span><span class="sxs-lookup"><span data-stu-id="62afb-583">nie número</span></span>
  
<span data-ttu-id="62afb-584">documento nacional de identidad</span><span class="sxs-lookup"><span data-stu-id="62afb-584">documento nacional de identidad</span></span>
  
<span data-ttu-id="62afb-585">identidad único</span><span class="sxs-lookup"><span data-stu-id="62afb-585">identidad único</span></span>
  
<span data-ttu-id="62afb-586">número nacional identidad</span><span class="sxs-lookup"><span data-stu-id="62afb-586">número nacional identidad</span></span>
  
<span data-ttu-id="62afb-587">número de DNI</span><span class="sxs-lookup"><span data-stu-id="62afb-587">dni número</span></span>
  
<span data-ttu-id="62afb-588">dninúmero #</span><span class="sxs-lookup"><span data-stu-id="62afb-588">dninúmero#</span></span>
  
<span data-ttu-id="62afb-589">identidadúnico #</span><span class="sxs-lookup"><span data-stu-id="62afb-589">identidadúnico#</span></span>
  
## <a name="sweden"></a><span data-ttu-id="62afb-590">Suecia</span><span class="sxs-lookup"><span data-stu-id="62afb-590">Sweden</span></span>

<span data-ttu-id="62afb-591">Para obtener más información, consulte la sección "identificación nacional de Suecia" en [Qué buscan los tipos de información confidencial](what-the-sensitive-information-types-look-for.md).</span><span class="sxs-lookup"><span data-stu-id="62afb-591">For details, see the section "Sweden National ID" in [What the sensitive information types look for](what-the-sensitive-information-types-look-for.md).</span></span>
  
## <a name="see-also"></a><span data-ttu-id="62afb-592">Vea también</span><span class="sxs-lookup"><span data-stu-id="62afb-592">See also</span></span>

[<span data-ttu-id="62afb-593">Qué buscan los tipos de información confidencial</span><span class="sxs-lookup"><span data-stu-id="62afb-593">What the sensitive information types look for</span></span>](what-the-sensitive-information-types-look-for.md)
