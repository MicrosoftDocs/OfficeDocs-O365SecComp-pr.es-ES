...
> [!TIP]
>  Puede copiar y pegar el contenido del encabezado del mensaje en la herramienta [Analizador de mensaje](https://testconnectivity.microsoft.com/?tabid=mha). Esta herramienta le ayuda a analizar los encabezados y los convierte en un formato más legible.
