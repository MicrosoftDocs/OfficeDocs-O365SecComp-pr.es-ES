...
- actividades de exhibición de documentos electrónicos en el centro de cumplimiento de seguridad de Office 365 &
...
4. Configurar los criterios de búsqueda siguientes:
    ...
    > [!TIP]
    > Si busca todas las actividades relacionadas con un **sitio**, agregue el símbolo de comodín (\*) después de la dirección URL para devolver todas las entradas para ese sitio; Por ejemplo, **"https://contoso-my.sharepoint.com/personal/*"**.
...
Las tablas de esta sección describen las actividades que se auditan en Office 365. Para buscar estos eventos, puede buscar en el registro de auditoría en el centro de cumplimiento de seguridad &.
...
|[actividades de exhibición de documentos electrónicos](#ediscovery-activities) <br/> |[Actividades de Power BI](#power-bi-activities) <br/> |[Análisis de área de trabajo de Microsoft](#microsoft-workplace-analytics-activities)<br/>|
...
|Administración de colección de sitios se ha agregado  <br/> |SiteCollectionAdminAdded  <br/> |Administrador de colección de sitios o propietario agrega a una persona como un administrador de colección de sitios para un sitio. Los administradores de colección de sitios tienen permisos de control total para la colección de sitios y todos los subsitios. Esta actividad también se registra cuando un administrador proporciona a sí mismos acceso a una cuenta de usuario OneDrive (mediante la edición del perfil de usuario en el centro de administración de SharePoint o [mediante el centro de administración de Office 365](https://docs.microsoft.com/office365/admin/add-users/get-access-to-and-back-up-a-former-user-s-data#part-1---get-access-to-the-former-employees-onedrive-for-business-documents)).<br/> |
|(ninguno)  <br/> |SiteCollectionAdminRemoved <br/> |Administrador de colección de sitios o propietario quita a una persona como un administrador de colección de sitios para un sitio. Esta actividad también se registra cuando un administrador que ellos mismos quita de la lista de administradores de colección de sitios para una cuenta de usuario OneDrive (mediante la edición del perfil de usuario en el centro de administración de SharePoint).  Tenga en cuenta que para devolver esta actividad en los resultados de búsqueda de registro de auditoría, tendrá que buscar todas las actividades. <br/> |
...
|Usuario eliminado  <br/> |Delete user  <br/> |Se eliminó una cuenta de usuario de Office 365.  <br/> |
...
|**Nombre descriptivo**|**Operation**|**Descripción**|
|:-----|:-----|:-----|
|Vínculo al que se accede de OData <br/> |AccessedOdataLink <br/> |Analista de tener acceso al vínculo de OData para una consulta.|
|Consulta cancelada <br/> |CanceledQuery <br/> |Analista de cancela una consulta que se está ejecutando.|
|Exclusión de reunión creada <br/> |MeetingExclusionCreated <br/> |Analista creado una nueva regla de exclusión de la reunión.|
|Resultado eliminado <br/> |DeletedResult <br/> |Analista de elimina un resultado de la consulta.|
|Informe descargado <br/> |DownloadedReport <br/> |Analista de descarga un archivo de resultados de consulta.|
|Consulta ejecutada <br/> |ExecutedQuery <br/> |Analista ejecutó una consulta.|
|Configuración de acceso de datos actualizados <br/> |UpdatedDataAccessSetting <br/> |Admin actualizó la configuración de acceso de datos.|
|Configuración de privacidad actualizada <br/> |UpdatedPrivacySetting <br/> |Admin actualizó la configuración de privacidad; Por ejemplo, el tamaño mínimo del grupo.|
|Datos de la organización que se cargan <br/> |UploadedOrgData <br/> |Archivo de datos de la organización que se cargan de administración.|
|Ver explorar <br/> |ViewedExplore <br/> |Analista de ve visualizaciones en las fichas de página explorar uno o más.|
||||
...
- **Office 365 E5** - auditoría se retienen los registros de 365 días (un año). Conservar registros de auditoría para un año también está disponible para las organizaciones que tienen una suscripción E3 y una suscripción de complemento de Office 365 avanzada cumplimiento.
     ...
     > [!NOTE]
     > Como ya se explicó, el período de retención de un año para los registros de auditoría para las organizaciones E5 (o E3 de las organizaciones que tienen licencias adicionales de cumplimiento de normas avanzadas) está actualmente disponible sólo como parte de un programa de vista previa privada. Para inscribirse en este programa de vista previa, presentar una solicitud con el [Soporte técnico de Microsoft](https://docs.microsoft.com/en-us/office365/admin/contact-support-for-business-products?redirectSourcePath=%252fen-us%252farticle%252fcontact-support-for-business-products-admin-help-32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b&view=o365-worldwide&tabs=online) y se incluyen los siguientes como la descripción de lo que necesita ayuda con: "A largo plazo Office 365 auditoría registro privada preview".
...
**¿Hay otras maneras de obtener registros aparte de utilizar el centro de cumplimiento de seguridad de Office 365 & o la API de actividad de administración de Office 365 de auditoría?**
