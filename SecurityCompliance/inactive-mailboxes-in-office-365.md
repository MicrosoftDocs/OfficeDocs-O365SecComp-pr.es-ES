...
Además de la retención por juicio, el uso de la nueva característica de la Directiva de retención &amp; de Office 365 en el centro de seguridad y cumplimiento es otra forma de poner un buzón inactivo. Para usar una directiva de retención para crear un buzón inactivo: 
...
- Podrá identificar fácilmente la Directiva de retención que está asignada a los buzones inactivos en su organización. Esto hará que sea más fácil cambiar la configuración de retención (o eliminación) si es necesario. También facilitará la eliminación permanente de un buzón inactivo, ya que sólo se puede quitar de la Directiva mediante el centro de seguridad &amp; y cumplimiento. De lo contrario, tiene que usar Exchange Online PowerShell para quitar una retención por juicio de un buzón inactivo o usar &amp; PowerShell del centro de seguridad y cumplimiento para excluir un buzón inactivo de una directiva de retención de Office 365 de toda la organización.
...
Para obtener más información acerca de los casos y las suspensiones de eDiscovery, vea [casos &amp; de eDiscovery en el centro de seguridad y cumplimiento de Office 365](ediscovery-cases.md).
...
Si se aplicó una directiva de retención de Exchange (la característica de administración de registros de mensajería, o MRM, en Exchange Online) al buzón de correo cuando se inactivo, cualquier directiva de eliminación (que sea una etiqueta de retención configurada con una acción de retención de **eliminación** ) se seguir procesándose en el buzón inactivo. Esto significa que los elementos etiquetados con una directiva de eliminación se moverán a la carpeta elementos recuperables cuando expire el período de retención. Estos elementos se purgan del buzón inactivo cuando expira la duración de retención. Si no se especifica una duración de retención para el buzón inactivo, los elementos de la carpeta elementos recuperados se conservarán indefinidamente. 
  
Por el contrario, se omiten todas las directivas de archivo (que son etiquetas de retención configuradas con una acción de retención **MoveToArchive** ) que se incluyen en la Directiva de retención asignada a un buzón inactivo. Esto significa que los elementos de un buzón inactivo etiquetados con una directiva de archivo permanecerán en el buzón de correo principal cuando expire el período de retención. No se mueven al buzón de archivo o a la carpeta elementos recuperables del buzón de archivo. Se conservarán indefinidamente. 
  
## <a name="creating-an-inactive-mailbox"></a>Creación de un buzón inactivo

Para convertir un buzón en inactivo, se le debe asignar una licencia de Exchange Online (plan 2), de modo que se pueda aplicar una directiva de retención por juicio u Office 365 al buzón antes de eliminarlo. Una vez eliminado el buzón de correo, la licencia de Exchange online que estuviera asociada a él estará disponible para asignarlo a un nuevo usuario. Los buzones inactivos no requieren licencias continuas.
